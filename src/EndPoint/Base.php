...
use CloudBrowser\Adapter\HttpAdapter;
use CloudBrowser\Adapter\Result;

/**
 * The base API request class
 */
class Base {
	const HOST = 'https://api.cloudbrowser.co/v1';
	private $apiKey;
	protected $payload;
	...
	private function getMessage($code) {
		switch($code) {
			...
			case self::RESPONSE_BILLING:
				...
				break;
			case self::RESPONSE_RATE_LIMITED:
				return 'You have exceeded your allocated concurrent request allowance - for this reason you have been rate limited.';
				break;
